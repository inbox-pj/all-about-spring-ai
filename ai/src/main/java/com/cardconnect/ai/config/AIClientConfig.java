...
public class AIClientConfig {
    ...
    @Bean
    public ChatClient ollamaChatClient(ChatClient.Builder builder, ChatMemory chatMemory, RetrievalAugmentationAdvisor retrievalAugmentationAdvisor, ToolCallbackProvider toolCallbackProvider) {
